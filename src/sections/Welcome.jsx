  ...
  return (
    <div className="h-screen flex flex-col justify-center">
      ...
      <div className="flex space-x-4 mt-4">
        <button className="bg-indigo-600 font-semibold text-sm sm:text-base px-4 py-2 rounded-md text-white border border-gray-200 dark:border-gray-700 hover:bg-indigo-800 hover:text-white active:transform active:scale-90 duration-200">Download Resume</button>
